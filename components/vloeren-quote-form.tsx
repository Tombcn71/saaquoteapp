  ...
  return (
    <Card className="w-full bg-white">
      <CardHeader className="bg-[#4285f4] text-white -mx-6 -mt-6 px-6 py-4 rounded-t-lg">
        <h3 className="text-xl font-bold">Direct een prijsindicatie en AI preview van uw nieuwe vloer</h3>
        <p className="text-sm opacity-90">Vul uw voorkeuren in voor de nieuwe vloer</p>
      </CardHeader>
